...
export default function GraphicsD() {
  return (
    ...
    <div className='flex mx-auto px-8 text-center'>
        <h1 className='text-xl sm:text-2xl lg:text-5xl py-4 font-bold'>2D/3D Graphics</h1>
    </div>
    ...
    <div className="py-12 flex justify-center flex-wrap">
        ...
        <div className="max-w-[28rem] m-5 p-5 rounded overflow-hidden text-center flex flex-col justify-center">
            <img src='https://www.softechgoal.com/2danimationport3.jpg' className='shadow-lg' alt="#" />
        </div>

        <div className="max-w-[28rem] m-5 p-5 rounded overflow-hidden text-center flex flex-col justify-center">
            <img src='https://www.softechgoal.com/2danimationport1.jpg' className='shadow-lg' alt="#" />
        </div>
